...
WebSocketChannel connect(Uri uri, {Iterable<String>? protocols, Duration? pingInterval}) =>
    IOWebSocketChannel.connect(uri, protocols: protocols, pingInterval: pingInterval);
